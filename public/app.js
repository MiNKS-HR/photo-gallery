...
var Gallery = function (_React$Component) {
  ...
  _createClass(Gallery, [{
    ...
    value: function hasImages(prop) {
      if (prop.length === 0) {
        return _react2.default.createElement('img', { src: 'img/no-photo.jpg', alt: 'Not available', className: 'main' });
      } else if (prop.length === 1) {
        return _react2.default.createElement('img', { src: this.state[0].url, alt: 'Main', className: 'main' });
      } else {
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement('img', { src: this.state.images[0].url, alt: 'Main', 'data-toggle': 'modal', 'data-target': '#mod', className: 'main' }),
          ...
          _react2.default.createElement(
            'div',
            { className: 'modal fade', id: 'mod', tabIndex: '-1', role: 'dialog', 'aria-hidden': 'true' },
            _react2.default.createElement(
              'div',
...
var Photo = function Photo(props) {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement('img', { src: props.image.url, alt: props.image.description })
  );
};
